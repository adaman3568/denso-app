...
const useInsertModal = (ChildNode : (successFunc : () => void,failedFunc : () => void) => ReactNode) => {
    ...
    const Modal = () => {
        return (
            <>
                <ModalWindow IsOpen={open} handleClose={() => setOpen(false)} ChildComponent={ChildNode(SuccessOpen,FailedOpen)}/>
